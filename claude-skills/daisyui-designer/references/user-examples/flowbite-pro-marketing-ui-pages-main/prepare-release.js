...
const REQUIRED_FILES = ['LICENSE.md', 'postcss.config.js', 'README.md', 'syntax.css', 'webpack.config.js'];
...
const REQUIRED_DEPS = [
    ...
    'terser-webpack-plugin', 'webpack', 'webpack-cli', 'webpack-dev-server', 'yarn', '@tailwindcss/postcss'
];
...
const compressReleaseDirectory = () => {
    const outputName = args.output || 'flowbite-pro-landing-pages';
